...
import 'package:sat_exam/api_value.dart';

class QuestionBankController extends GetxController {
  Dio dio = Dio();

  uploadQuestion(String subjectname, questiondata, answer, optionsList,
      topicName, difficultylevel) async {
    print(subjectname);
    //print(question);
    print(answer);
    //print(options);
    ...
    try {
      final response = await dio.post(
          "https://exam-portal-p3fq.onrender.com/post/question_bank",
          data: {
            "subject": subjectname,
